...
@section('conteudo')
    ...
    <div class="col-md-12 col-md-offset-0">
        <div class="panel panel-default">
            <div class="panel-heading">Palestrantes Cadastrados</div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($palestrantes as $palestrante)
                            <tr>
                                ...
                                <td>{{ $palestrante->Formacao }}</td>
                                <td><a href="/palestrante/edit/{{$palestrante->ID}}">Editar</a> |
                                    <a href="/palestrante/delete/{{$palestrante->ID}}">Excluir</a> </td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
    ...
    <div class="col-md-2">
        <a href="{{route('adm.cadPalestrante')}}" class="btn btn-primary">
            Cadastrar
        </a>
    </div>
